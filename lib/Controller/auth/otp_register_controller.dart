...
class OtpRegisterController extends GetxController {
  ...
  void navToRegister() {
    print(phoneNum);
    print(int.tryParse(otpController.text));
    Get.offAndToNamed("/register", arguments: {"phoneNum": phoneNum,"code":otpController.text});
  }
  ...
  Future<void> verifyOTP() async {
    ...
    try {
      ...
      dio.Response r = await d.post("$baseURL/api/v1/verifyAccount", data: {
  ...
  Future<void> resendOTP() async {
    ...
    try {
      dio.Response r =
          await d.post("$baseURL/api/v1/trainee/auth/resendOTP", data: {
        "phone_number": phoneNum,
      });
      if (r.statusCode == 200 && r.data["status"] == "success") {
