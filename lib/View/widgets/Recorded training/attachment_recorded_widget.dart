...
class AttachmentRecordedWidget
    extends GetWidget<ViewEnrolledRecordedCourseController> {
  const AttachmentRecordedWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final List<Attachments> attachments = lesson.attachments ?? [];
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) =>
            _buildAttachmentCard(attachments[index], context),
      );
    });
  }
