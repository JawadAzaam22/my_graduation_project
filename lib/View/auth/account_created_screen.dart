...
class AccountCreatedScreen extends GetWidget<PasswordChangedController> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.accCreated,
                ...
                Padding(
                  ...
                  child: Center(
                    child: Text(
                      AppLocalizations.of(context)!.accCreatedIntro,
